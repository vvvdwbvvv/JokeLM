...
from transformers.utils import is_liger_kernel_available, is_peft_available, is_datasets_available
from transformers.utils.deprecation import deprecate_kwarg

from trl.data_utils import is_conversational, maybe_apply_chat_template, pack_examples
...
class SFTTrainer(Trainer):
    ...
    # This is the only function customized and different from  `trl/SFTTrainer`
    def get_train_dataloader(self) -> DataLoader:
        ...
        # else: # NOTICE: This is the only difference from `trl/SFTTrainer`
